...
public class AddStudentActivity extends AppCompatActivity {
    ...
    public void fnRegister(View view) {
        ...
        if (!et_phone.getText().toString().trim().matches(phonenumberpattern)) {

            Toast.makeText(getApplicationContext(),"Invalid phone number",Toast.LENGTH_SHORT).show();
            return;
        }
        if (!et_user_id.getText().toString().trim().matches(usridpattern)) {
        ...
        try{
            final StudentInformation stdinfo=new StudentInformation(userid,name,rollno,dept,phone,email,password,subject);
